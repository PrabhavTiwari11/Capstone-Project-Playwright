...
- Name: user-profile.spec.js >> nopCommerce User Profile Test Cases >> PROFILE TC13 Save button should be clickable
- Location: tests/user-profile.spec.js:147:1
