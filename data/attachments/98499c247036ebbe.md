...
Locator: locator('.validation-summary-errors, .message-error, .field-validation-error')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('.validation-summary-errors, .message-error, .field-validation-error')
